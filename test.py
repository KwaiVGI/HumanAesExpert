...
if __name__ == '__main__':
    # load model
    model_path = 'HumanBeauty/HumanAesExpert-8B'
    ...
    for i, item in tqdm(enumerate(os.listdir(examples_path))):
        image_path = os.path.join(examples_path, item)
